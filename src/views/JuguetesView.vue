<template>
  <div v-if="productos.length === 0">
    <div class="container2 text-center my-5">
      <p class="text-center pt-2">No hay productos disponibles en esta categoría.</p>
    </div>
  </div>
  <div v-else>
    <div class="container">
...
import { recorridoJuguetes } from '../assets/js/recorrido.js'
...
export default {
  ...
  mounted() {
    recorridoJuguetes().then(productos => {
